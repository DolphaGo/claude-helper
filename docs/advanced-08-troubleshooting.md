...
**원인 1: Claude Code가 실행 중이 아님**

Scheduled Tasks는 Claude Code가 실행 중일 때만 작동합니다.

**해결:**
실행 시간에 Claude Code를 켜두세요.
...
```bash
tail -100 ~/.claude/logs/claude.log > error-log.txt
```
